...
export default function LichDichVu() {
    ...
    const fetchBookings = async () => {
        try {
            setLoading(true);
            const res = await bookingService.getBookingsByType('DICH_VU');
        ...
        <div className="orders-container">
            <header className="orders-header">
                <div className="title-group">
                    ...
                    <h1 className="orders-title">Lịch Hẹn Dịch Vụ</h1>
                </div>
            </header>
            ...
            <div className="orders-table-wrapper">
                <div className="table-header">
                    ...
                    <div style={{width: '20%'}}>Dịch Vụ</div>
                ...
                <div className="table-body">
                    {loading ? (
                        ...
                        <div className="table-empty">Hệ thống chưa ghi nhận lịch dịch vụ nào.</div>
                    ) : (
